<template>
  <div class="px-5 my-10 text-justify">
    <h1 class="font-semibold text-4xl">
      Privacy Policy for Qarpa
    </h1>

    <p>
      At Qarpa, accessible from qarpa-fe.fly.dev, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types
      of information that is collected and recorded by Qarpa and how we use it.
    </p>
    ...
    <h2 class="font-semibold text-3xl mt-4 mb-2">
      Log Files
    </h2>

    <p>
      Qarpa follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, Qarpa uses 'cookies'. These cookies are used to
    ...
    <p>
      ...
      <a href="https://www.privacypolicyonline.com/what-are-cookies/">the "Cookies" article from the Privacy Policy Generator</a>.
    </p>
    ...
    <P>
      ...
      advertising partners of Qarpa.
    </P>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Qarpa, which are sent directly to
    ...
    <p>
      Note that Qarpa has no access to or control over these cookies that are
    ...
    <p>
      Qarpa's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      Qarpa does not knowingly collect any Personal Identifiable Information
    ...
    <p>
      ...
      and/or collect in Qarpa. This policy is not applicable to any information
